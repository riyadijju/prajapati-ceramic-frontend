...
const UserPayments = () => {
  ...
  return (
    <div className='py-6 px-4'>
        ...
        <div>
            <p className='text-lg font-medium text-gray-800 mb-5'>Total Spent: Rs. {totalPayment ? totalPayment : 0}</p>
            <ul>
                {
                    orders && orders.map((item, index) => (
                        <li key={index}>
                            ...
                            <div>
                                <span className='text-red-900'> Rs. {item?.amount.toFixed(2)}</span>
                            </div>
